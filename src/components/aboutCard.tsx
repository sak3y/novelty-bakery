...
const AboutCard = () => {
  return (
    <section className="relative border-b border-[#E8CFA4] bg-[#FFF7ED]">
      <div className="relative z-0 h-[420px] md:h-[690px] overflow-hidden">
        <img
          src={heroBg}
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          <div className="max-w-2xl w-full sm:w-auto">
            {/* Outer ring */}
            <div className="bg-transparent border border-[#E8CFA4] px-2 py-2">
              {/* Inner card */}
              <div className="bg-[#FFF7ED] border border-[#F3D39A] px-6 sm:px-10 py-8 md:py-9 text-center">
                ...
                <div className="w-14 h-0.5 bg-[#C7A840] mx-auto mb-6" />
